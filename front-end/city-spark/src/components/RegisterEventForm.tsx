...
const RegisterEventForm: React.FC<RegisterEventFormProps> = ({ eventId }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try{
            ...
            response = await axios.post(`http://localhost:8080/cityspark/participation/registerAsAttendee`, requestBody);
    ...
    return (
        <form onSubmit={handleSubmit}>
         ...
         <label className="form-control w-full max-w-xs">
            ...
            <div className="label">
            <Input type="text" label="Person Name" name="personName" onChange={handleChange} />
            </div>
            <div className="label">
            <Input type="text" label="Person Contact No" name="personContactNo" onChange={handleChange} />
            </div>
         </label>
